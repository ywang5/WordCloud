...
def output():
	...
	words_to_ignore = ["gonna", "actually", "let", "okay", "like", "10", "beneath", "way", "come", "just", "said", "ms", "mr", "did", "yes", #Manually added ignorable words
...
#Now this algorithm runs on this duplicated essay for 20 seconds.