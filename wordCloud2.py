...
def output():
	...
	dictionary = dict() #dictionary stores all the processed words
	d=dict() #d stores the data that will be displayed. d will be passed into html.
	words_to_ignore = ["gonna", "actually", "let", "okay", "like", "10", "beneath", "way", "come", "just", "said", "ms", "mr", "did", "yes", #Manually added ignorable words by Yikai
